...
import com.objectcomputing.errors.BadRequestAlertException;
import com.objectcomputing.errors.EmailAlreadyUsedException;
import com.objectcomputing.errors.LoginAlreadyUsedException;
...
public class UserController {
    ...
    public HttpResponse<User> createUser(@Valid @Body UserDTO userDTO) throws URISyntaxException {
        ...
        } else if (userRepository.findByLogin(userDTO.getLogin().toLowerCase()).isPresent()) {
    ...
    public HttpResponse<UserDTO> updateUser(@Valid @Body UserDTO userDTO) {
        ...
        existingUser = userRepository.findByLogin(userDTO.getLogin().toLowerCase());
        if (existingUser.isPresent() && (!existingUser.get().getId().equals(userDTO.getId()))) {
            throw new LoginAlreadyUsedException();
        }
