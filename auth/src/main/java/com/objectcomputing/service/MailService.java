...
import com.objectcomputing.util.SpaProperties;
...
public class MailService {
    ...
    public MailService(SpaProperties spaProperties, //JavaMailSender javaMailSender,
    ...
    public void sendEmailFromTemplate(User user, String templateName, String titleKey) {
        ...
        context.setVariable(BASE_URL, spaProperties.getMail().getBaseUrl());
